...
// V2reportsTaxonomyNamesDataReportPage struct for V2reportsTaxonomyNamesDataReportPage
...
func NewV2reportsTaxonomyNamesDataReportPage() *V2reportsTaxonomyNamesDataReportPage {
	this := V2reportsTaxonomyNamesDataReportPage{}
	return &this
}
...
func (o *V2reportsTaxonomyNamesDataReportPage) GetReports() []V2reportsTaxonomyNamesReportMatch {
	if o == nil || o.Reports == nil {
		var ret []V2reportsTaxonomyNamesReportMatch
		return ret
	}
	return o.Reports
}
...
// SetReports gets a reference to the given []V2reportsTaxonomyNamesReportMatch and assigns it to the Reports field.
...
func (o V2reportsTaxonomyNamesDataReportPage) MarshalJSON() ([]byte, error) {
...
type NullableV2reportsTaxonomyNamesDataReportPage struct {
	value *V2reportsTaxonomyNamesDataReportPage
	isSet bool
}

func (v NullableV2reportsTaxonomyNamesDataReportPage) Get() *V2reportsTaxonomyNamesDataReportPage {
	return v.value
}

func (v *NullableV2reportsTaxonomyNamesDataReportPage) Set(val *V2reportsTaxonomyNamesDataReportPage) {
	v.value = val
	v.isSet = true
}

func (v NullableV2reportsTaxonomyNamesDataReportPage) IsSet() bool {
	return v.isSet
}

func (v *NullableV2reportsTaxonomyNamesDataReportPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2reportsTaxonomyNamesDataReportPage(val *V2reportsTaxonomyNamesDataReportPage) *NullableV2reportsTaxonomyNamesDataReportPage {
	return &NullableV2reportsTaxonomyNamesDataReportPage{value: val, isSet: true}
}

func (v NullableV2reportsTaxonomyNamesDataReportPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2reportsTaxonomyNamesDataReportPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
